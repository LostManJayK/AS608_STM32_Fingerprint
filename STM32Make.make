...
C_SOURCES =  \
Core/Src/AS608.c \
Core/Src/C031C6_DMA.c \
Core/Src/C031C6_GPIO.c \
Core/Src/C031C6_Rcc.c \
Core/Src/C031C6_USART.c
...
GCC_PATH="/home/andrew/Documents/Dev/Embedded/Setup/gcc-arm-none-eabi/bin
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"/home/andrew/Documents/Dev/Embedded/Setup/openocd/bin/openocd" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"/home/andrew/Documents/Dev/Embedded/Setup/openocd/bin/openocd" -f ./openocd.cfg -c "init; reset halt;  mass_erase 0; exit"
